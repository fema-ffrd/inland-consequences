...
def test_formatBuildings():
    ...
    test_bldg_path = r"C:\inland-consequences_costal_tool\TEST_CALC\input\Calc_bldg_sample.shp"
    ...
    correct_output_shp_path = r"C:\inland-consequences_costal_tool\TEST_CALC\output\Test1_BUILDINGS.shp"
    correct_out_gdf = gpd.read_file(correct_output_shp_path)

    ret = lib.formatBuildings(test_inputs)
    assert ret == correct_out_gdf
...
def test_validateSurgeAttr2(get_comparison_data):
    ...
    for run_type in ['surgeA','surgeB','waveA','waveB']:
        ...
        s_tab = gpd.read_file(run_data['dbf_path'][run_type])
        ...
        ret = lib.validateSurgeAttr2(run_data['src_data'][run_type], attr_map)
